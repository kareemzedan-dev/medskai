...
mixin _$WishlistStore on _WishlistStore, Store {
  ...
  late final _$courseIdSetAtom =
      Atom(name: '_WishlistStore.courseIdSet', context: context);

  @override
  ObservableSet<int> get courseIdSet {
    _$courseIdSetAtom.reportRead();
    return super.courseIdSet;
  }

  @override
  set courseIdSet(ObservableSet<int> value) {
    _$courseIdSetAtom.reportWrite(value, super.courseIdSet, () {
      super.courseIdSet = value;
    });
  }
