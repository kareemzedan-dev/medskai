...
part of 'learning_quiz_store.dart';
...
mixin _$LearningQuizStore on _LearningQuizStore, Store {
  late final _$dataQuizAtom =
      Atom(name: '_LearningQuizStore.dataQuiz', context: context);
  ...
  late final _$itemQuestionAtom =
      Atom(name: '_LearningQuizStore.itemQuestion', context: context);
  ...
  late final _$itemCheckAtom =
      Atom(name: '_LearningQuizStore.itemCheck', context: context);
  ...
  late final _$_LearningQuizStoreActionController =
      ActionController(name: '_LearningQuizStore', context: context);

  @override
  void setData(dynamic value) {
    final _$actionInfo = _$_LearningQuizStoreActionController.startAction(
        name: '_LearningQuizStore.setData');
    try {
      return super.setData(value);
    } finally {
      _$_LearningQuizStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setQuestion(dynamic value) {
    final _$actionInfo = _$_LearningQuizStoreActionController.startAction(
        name: '_LearningQuizStore.setQuestion');
    try {
  ...
  void setItemCheckuestion(dynamic value) {
    final _$actionInfo = _$_LearningQuizStoreActionController.startAction(
        name: '_LearningQuizStore.setItemCheckuestion');
    try {
